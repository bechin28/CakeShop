	  ...
	  <div>
	    <div>
	      <div id="logo"> <a href="index.php"><img src="images/logo.gif" width="350px" height="110px" alt="Logo"/></a> </div>
		    <div>
		      <div id ="giohang"> <a href="giohang.php">Giỏ hàng <img src="images/logo-panier.gif"/></a>
              <?php session_start(); 
					...
					<form action="signup.php" method="post">
						...
						<table>
							<tr>
								...
								<td><input type="text" id="email" name="email_name"   /></td>
							</tr>
							<tr>
								<td><label for="ten">Họ và tên của bạn</label></td>
								<td><input type="text" id="ten" name="khach"  /></td>
							</tr>
                            <tr>
								<td><label for="diachi">Địa chỉ giao hàng</label></td>
								<td><input type="text" id="diachi" name="add" /></td>
							</tr>
                            <tr>
								<td><label for="sdt">Số điện thoại liên hệ</label></td>
								<td><input type="text" id="sdt" name="dienthoai" /></td>
							</tr>
							<tr>
							...
							<tr>
								<td><label for="confirmpass">Nhập lại<br />Mật khẩu</label></td>
								<td><input type="password" id="confirmpass" name="r_mk" /></td>
							</tr>
							<tr>
								<td></td>
								<td class="rememberme"><label for="rememberme"><input type="checkbox" id="rememberme" 
                                name="check" /> Duy trì đăng nhập</label></td>
							</tr>
						</table>
						<input type="submit" value="Đăng ký" name="dangky"  class="submitbtn"/>
					</form>
